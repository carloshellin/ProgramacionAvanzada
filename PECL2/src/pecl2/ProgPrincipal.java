...
// Programa Principal que se encarga de hacer de servidor y de mostrar la exposición
public class ProgPrincipal extends javax.swing.JFrame
{
    private boolean RMI = false; // Si es false usa Socket, sino RMI
    // Si se cambia RMI en ProgPrincipal, se debe cambiar también en ModControl
    ...
    public ProgPrincipal()
    {
        ...
        if (RMI)
        {
            servidorRMI = new ServidorRMI(paso);
        }
        else
        {
        ...
        exposicion=new Exposicion(10,jTextField1,jTextField2, paso);
        for(int i=1; i<=60; i++)
        {
            v = new Visitante(i,exposicion,paso);
            v.start();
        }
    }
